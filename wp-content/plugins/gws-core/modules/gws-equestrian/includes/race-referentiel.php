...
function gwseq_race_referentiel_raw_entries() {
  return array(
    ...
    array('code' => 'BWP', 'ifce' => 'Belgisch Warmbloedpaard', 'gws' => 'BWP', 'type' => 'race', 'alias' => array('Belgian Warmblood'), 'usage' => 'courant sport'),
    ...
    array('code' => 'HAN', 'ifce' => 'Hanovrien', 'gws' => 'Hanovrien', 'type' => 'race', 'alias' => array('Hannoveraner'), 'usage' => 'courant sport/dressage'),
    ...
    array('code' => 'KWPN', 'ifce' => 'Koninklijke Vereniging Warmbloed Paardenstamboek Nederland', 'gws' => 'KWPN', 'type' => 'race', 'alias' => array('Kon. Warm Paard Nederland'), 'usage' => 'courant sport/dressage'),
    ...
    array('code' => 'SF', 'ifce' => 'Selle Français', 'gws' => 'Selle Français', 'type' => 'race', 'alias' => array('SFA', 'Selle Français Section A'), 'usage' => 'très courant sport'),
    ...
    array('code' => 'OE', 'ifce' => 'Origine Étrangère', 'gws' => 'Origine Étrangère', 'type' => 'appellation', 'alias' => array('OES', 'OEP', 'Origine étrangère selle'), 'usage' => 'courant import'),
  );
}
