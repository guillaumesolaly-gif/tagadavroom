...
## Diagnostic instrumenté de performance — fiche Cheval (0.36.0, itérations 2 et 3 en 0.37.0/0.38.0)
...
désormais ajoutés au même profileur générique, sans nouvelle technique. Toujours aucun correctif à
ce stade. Ce fichier est destiné à être retiré une fois la cause confirmée et corrigée — voir
`tests/gws-equestrian-cheval-perf-diagnostic-test.php` (vérifie explicitement l'absence de tout
changement de comportement) et le `CHANGELOG.md` de ce dossier (0.38.0, 0.37.0 et 0.36.0) pour le
détail complet.
