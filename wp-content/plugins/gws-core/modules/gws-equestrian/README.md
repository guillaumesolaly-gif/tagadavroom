...
## Diagnostic instrumenté de performance — fiche Cheval (0.36.0)
...
pied de l'écran d'édition et, si `WP_DEBUG_LOG` est actif, journalisé. Ce fichier est destiné à
être retiré une fois la cause confirmée et corrigée — voir `tests/gws-equestrian-cheval-perf-
diagnostic-test.php` (vérifie explicitement l'absence de tout changement de comportement) et le
`CHANGELOG.md` de ce dossier (0.36.0) pour le détail complet.
